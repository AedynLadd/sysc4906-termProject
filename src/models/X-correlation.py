...
def compute_cross_correlation(dataset1, dataset2):
    lags = np.arange(-(150), (150), 1)  # uncontrained
            ...
            try:
                ...
                if(len(merged_data) <= 20):
                    ...
                    if coin_name == "Bitcoin":
                        ...
                        ax[1].plot(np.array(merged_data["sentiment"]), color="r", label="Sentiment Cost")
                        ax[1].legend()
                    ...
                    if coin_name == "Bitcoin":
                        ...
                        ax[1].plot(np.array(df_difference["sentiment"]), color="r", label="Sentiment Cost")
                        ax[1].legend()
